...
namespace ExcelReporter.Tests.Implementations.Panels.Excel.PanelRenderTests.DataSourcePanelRenderTests
{
    ...
    {
        [TestMethod]
        public void Test_VerticalPanelsGrouping_ChildBottom_ParentCellsShiftChildCellsShift_NotWorkProperly()
        {
            ...
            Assert.AreEqual(XLBorderStyleValues.Thin, ws.Cell(3, 2).Style.Border.BottomBorder);
            Assert.AreEqual(XLColor.Black, ws.Cell(3, 2).Style.Border.BottomBorderColor);
            ...
            Assert.AreEqual(XLColor.Black, ws.Cell(3, 3).Style.Border.BottomBorderColor);
            ...
            Assert.AreEqual(XLColor.Black, ws.Cell(3, 4).Style.Border.BottomBorderColor);
            ...
            Assert.AreEqual(XLColor.Black, ws.Cell(3, 5).Style.Border.BottomBorderColor);
            ...
            Assert.AreEqual(XLColor.Black, ws.Cell(4, 2).Style.Border.BottomBorderColor);
            ...
            Assert.AreEqual(XLColor.Black, ws.Cell(4, 3).Style.Border.BottomBorderColor);
            ...
            Assert.AreEqual(XLColor.Black, ws.Cell(4, 4).Style.Border.BottomBorderColor);
            ...
            Assert.AreEqual(XLColor.Black, ws.Cell(4, 5).Style.Border.BottomBorderColor);
            ...
            Assert.AreEqual(XLBorderStyleValues.None, ws.Cell(6, 2).Style.Border.BottomBorder);
            ...
            Assert.AreEqual(XLBorderStyleValues.None, ws.Cell(6, 3).Style.Border.BottomBorder);
            ...
            Assert.AreEqual(XLBorderStyleValues.None, ws.Cell(6, 4).Style.Border.BottomBorder);
            ...
            Assert.AreEqual(XLBorderStyleValues.None, ws.Cell(6, 5).Style.Border.BottomBorder);
            Assert.AreEqual(XLBorderStyleValues.None, ws.Cell(6, 5).Style.Border.LeftBorder);

            Assert.AreEqual("Test3", ws.Cell(7, 2).Value);
            ...
            Assert.AreEqual(new DateTime(2017, 11, 3), ws.Cell(7, 3).Value);
            ...
            Assert.AreEqual("Test3_Child1_F1", ws.Cell(8, 3).Value);
            ...
            Assert.AreEqual("Test3_Child1_F2", ws.Cell(8, 4).Value);
            ...
            Assert.AreEqual("Test3_Child2_F1", ws.Cell(9, 3).Value);
            Assert.AreEqual(XLBorderStyleValues.Thin, ws.Cell(9, 3).Style.Border.TopBorder);
            Assert.AreEqual(XLColor.Red, ws.Cell(9, 3).Style.Border.TopBorderColor);
            ...
            Assert.AreEqual(XLBorderStyleValues.Thin, ws.Cell(9, 3).Style.Border.LeftBorder);
            Assert.AreEqual(XLColor.Red, ws.Cell(9, 3).Style.Border.LeftBorderColor);

            Assert.AreEqual("Test3_Child2_F2", ws.Cell(9, 4).Value);
            Assert.AreEqual(XLBorderStyleValues.Thin, ws.Cell(9, 4).Style.Border.TopBorder);
            Assert.AreEqual(XLColor.Red, ws.Cell(9, 4).Style.Border.TopBorderColor);
            ...
            Assert.AreEqual(5500.8d, ws.Cell(9, 5).Value);
            Assert.AreEqual(XLBorderStyleValues.Thin, ws.Cell(9, 5).Style.Border.TopBorder);
            Assert.AreEqual(XLColor.Red, ws.Cell(9, 5).Style.Border.TopBorderColor);
            ...
            Assert.AreEqual(ws.Cell(9, 2), ws.NamedRange("ChildRange").Ranges.ElementAt(0).FirstCell());
            Assert.AreEqual(ws.Cell(9, 5), ws.NamedRange("ChildRange").Ranges.ElementAt(0).LastCell());
        ...
        [TestMethod]
        public void Test_VerticalPanelsGrouping_ChildBottom_ParentRowShiftChildCellsShift_NotWorkProperly()
        {
            var report = new TestReport();
            IXLWorksheet ws = report.Workbook.AddWorksheet("Test");
            IXLRange parentRange = ws.Range(2, 2, 3, 5);
        ...
        [TestMethod]
        public void Test_VerticalPanelsGrouping_ChildBottom_ParentRowShiftChildRowShift_NotWorkProperly()
        {
            var report = new TestReport();
            IXLWorksheet ws = report.Workbook.AddWorksheet("Test");
            IXLRange parentRange = ws.Range(2, 2, 3, 5);
        ...
        [TestMethod]
        public void Test_VerticalPanelsGrouping_ChildBottom_ParentNoShiftChildCellsShift_NotWorkProperly()
        {
            var report = new TestReport();
            IXLWorksheet ws = report.Workbook.AddWorksheet("Test");
            IXLRange parentRange = ws.Range(2, 2, 3, 5);
            ...
            Assert.AreEqual(1, ws.NamedRanges.Count());
            Assert.AreEqual(1, ws.NamedRange("ChildRange").Ranges.Count);
            Assert.AreEqual(ws.Cell(5, 2), ws.NamedRange("ChildRange").Ranges.ElementAt(0).FirstCell());
        ...
        public void Test_VerticalPanelsGrouping_ChildBottom_ParentCellsShiftChildCellsShift_WithFictitiousRow()
        {
            ...
            var parentPanel = new ExcelDataSourcePanel("m:TestDataProvider:GetIEnumerable()", ws.NamedRange("ParentRange"), report);
            var childPanel = new ExcelDataSourcePanel("m:TestDataProvider:GetChildIEnumerable(di:Name)", ws.Workbook.NamedRange("ChildRange"), report)
            {
                Parent = parentPanel,
            };
            parentPanel.Children = new[] { childPanel };
            ...
            Assert.AreEqual(string.Empty, ws.Cell(6, 2).Value);
            ...
            Assert.AreEqual(string.Empty, ws.Cell(6, 3).Value);
            ...
            Assert.AreEqual("Test2", ws.Cell(7, 2).Value);
            Assert.AreEqual(XLBorderStyleValues.Thin, ws.Cell(7, 2).Style.Border.TopBorder);
            Assert.AreEqual(XLColor.Black, ws.Cell(7, 2).Style.Border.TopBorderColor);
            Assert.AreEqual(XLBorderStyleValues.None, ws.Cell(7, 2).Style.Border.RightBorder);
            Assert.AreEqual(XLBorderStyleValues.None, ws.Cell(7, 2).Style.Border.BottomBorder);
            ...
            Assert.AreEqual(new DateTime(2017, 11, 2), ws.Cell(7, 3).Value);
            Assert.AreEqual(XLBorderStyleValues.Thin, ws.Cell(7, 3).Style.Border.TopBorder);
            Assert.AreEqual(XLColor.Black, ws.Cell(7, 3).Style.Border.TopBorderColor);
            Assert.AreEqual(XLBorderStyleValues.None, ws.Cell(7, 3).Style.Border.RightBorder);
            Assert.AreEqual(XLBorderStyleValues.None, ws.Cell(7, 3).Style.Border.BottomBorder);
            ...
            Assert.AreEqual(string.Empty, ws.Cell(8, 3).Value);
            ...
            Assert.AreEqual(string.Empty, ws.Cell(12, 2).Value);
            ...
            Assert.AreEqual(string.Empty, ws.Cell(12, 3).Value);
            ...
            Assert.AreEqual(1, ws.Workbook.NamedRange("ChildRange").Ranges.Count);
            Assert.AreEqual(ws.Cell(11, 2), ws.Workbook.NamedRange("ChildRange").Ranges.ElementAt(0).FirstCell());
            Assert.AreEqual(ws.Cell(11, 5), ws.Workbook.NamedRange("ChildRange").Ranges.ElementAt(0).LastCell());
        ...
        public void Test_VerticalPanelsGrouping_ChildBottom_ParentRowShiftChildCellsShift_WithFictitiousRow()
        {
            ...
            Assert.AreEqual("{di:Name}", ws.Cell(1, 1).Value);
            Assert.AreEqual("{di:Name}", ws.Cell(11, 1).Value);
            Assert.AreEqual("{di:Name}", ws.Cell(1, 6).Value);
            Assert.AreEqual("{di:Name}", ws.Cell(11, 6).Value);
        ...
        public void Test_VerticalPanelsGrouping_ChildBottom_ParentRowShiftChildRowShift_WithFictitiousRow()
        {
            ...
            Assert.AreEqual("{di:Name}", ws.Cell(11, 1).Value);
            Assert.AreEqual("{di:Name}", ws.Cell(1, 6).Value);
            Assert.AreEqual("{di:Name}", ws.Cell(13, 6).Value);
            Assert.AreEqual("{di:Name}", ws.Cell(13, 1).Value);
            Assert.AreEqual("{di:Name}", ws.Cell(11, 6).Value);
            Assert.AreEqual("{di:Name}", ws.Cell(1, 4).Value);
            Assert.AreEqual("{di:Name}", ws.Cell(13, 4).Value);
        ...
        public void Test_VerticalPanelsGrouping_ChildBottom_ParentNoShiftChildRowShift_WithFictitiousRow()
        {
            ...
            Assert.AreEqual(1, ws.Workbook.NamedRanges.Count());
            Assert.AreEqual(1, ws.Workbook.NamedRange("ChildRange").Ranges.Count);
            Assert.AreEqual(ws.Cell(5, 2), ws.Workbook.NamedRange("ChildRange").Ranges.ElementAt(0).FirstCell());
            Assert.AreEqual(ws.Cell(5, 5), ws.Workbook.NamedRange("ChildRange").Ranges.ElementAt(0).LastCell());
