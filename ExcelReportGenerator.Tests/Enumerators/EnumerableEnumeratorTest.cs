...
namespace ExcelReportGenerator.Tests.Enumerators
{
    public class EnumerableEnumeratorTest
    {
        ...
        public void TestEnumerator()
        {
            ...
            IDictionary<string, object> dict = new Dictionary<string, object> { ["One"] = 1, ["Two"] = "Two", ["Three"] = Guid.NewGuid() };
        ...
        private class CustomEnumerable<T> : IEnumerable<T>
        {
            ...
            public IEnumerator<T> GetEnumerator() => new CustomEnumerator<T>(_enumerable);
