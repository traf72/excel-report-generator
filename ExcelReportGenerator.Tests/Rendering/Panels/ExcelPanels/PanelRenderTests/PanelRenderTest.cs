...
public class PanelRenderTest
{
    ...
    public void TestPanelRender()
    {
        ...
        ws.Cell(3, 1).Value =
            "Int: { p:IntParam }. Str: {p:ComplexTypeParam.StrParam}. FormattedDate: {M:Format(p:DateParam)}. NullProp: {p:NullProp}";
        ...
        Assert.AreEqual("Int: 10. Str: Complex type string parameter. FormattedDate: 20171025. NullProp: ",
            ws.Cell(3, 1).Value);
    ...
    public void TestOuterMethodCallCrash()
    {
        ...
        ExceptionAssert.Throws<MethodNotFoundException>(() => panel.Render(),
            "Could not find public method \"Format2\" in type \"TestReport\" and all its parents. MethodCallTemplate: Format2(m:Counter(), \"d\")");
    }
    ...
    public void TestInnerMethodCallCrash()
    {
        ...
        var panel = new ExcelPanel(range, report, report.TemplateProcessor);
        ExceptionAssert.Throws<MethodNotFoundException>(() => panel.Render(),
            "Could not find public method \"Counter2\" in type \"TestReport\" and all its parents. MethodCallTemplate: Counter2()");
    }
    ...
    public void TestNamedPanelRender()
    {
        ...
        ws.Cell(2, 5).Value = "''{m:Format(p:DateParam)}";
        ws.Cell(3, 1).Value =
            "Int: { p:IntParam }. Str: {p:ComplexTypeParam.StrParam}. FormattedDate: {m:Format(p:DateParam)}";
        ws.Cell(3, 2).Value = "''{m:Format(m:DateTime:AddDays(p:ComplexTypeParam.IntParam), \"yyyy-MM-dd\")}";
    ...
    public void TestSimplePanelExpansion()
    {
        ...
        var totalsPanelRange = ws.Range(3, 2, 3, 5);
