...
public class DataSourcePanelRender_WithGrouping_VerticalPanels_ChildBottom_Test
{
    ...
    public void Test_VerticalPanelsGrouping_ChildBottom_ParentCellsShiftChildCellsShift()
    {
        ...
        ExcelAssert.AreWorkbooksContentEqual(TestHelper.GetExpectedWorkbook(
            nameof(DataSourcePanelRender_WithGrouping_VerticalPanels_ChildBottom_Test),
    ...
    [Test]
    public void
        Test_VerticalPanelsGrouping_ChildBottom_ParentCellsShiftChildCellsShift_WithFictitiousRowWhichDeleteAfterRender()
    {
        var report = new TestReport();
        var ws = report.Workbook.AddWorksheet("Test");
        var parentRange = ws.Range(2, 2, 4, 5);
