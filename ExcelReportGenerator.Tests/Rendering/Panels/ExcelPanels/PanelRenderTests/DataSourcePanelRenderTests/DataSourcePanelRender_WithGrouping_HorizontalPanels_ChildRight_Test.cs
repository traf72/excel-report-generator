...
public class DataSourcePanelRender_WithGrouping_HorizontalPanels_ChildRight_Test
{
    ...
    public void Test_HorizontalPanelsGrouping_ChildRight_ParentCellsShiftChildCellsShift()
    {
        ...
        ExcelAssert.AreWorkbooksContentEqual(TestHelper.GetExpectedWorkbook(
            nameof(DataSourcePanelRender_WithGrouping_HorizontalPanels_ChildRight_Test),
    ...
    [Test]
    public void
        Test_HorizontalPanelsGrouping_ChildRight_ParentCellsShiftChildCellsShift_WithFictitiousColumnWhichDeleteAfterRender()
    {
        var report = new TestReport();
        var ws = report.Workbook.AddWorksheet("Test");
        var parentRange = ws.Range(2, 2, 5, 4);
