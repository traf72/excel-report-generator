...
public class DataSourcePanelDictionaryRenderTest
{
    ...
    public void TestRenderDictionary()
    {
        ...
        var range1 = ws.Range(2, 2, 2, 3);
        range1.AddToNamed("TestRange", XLScope.Worksheet);

        var range2 = ws.Range(2, 5, 2, 6);
        ...
        ExcelAssert.AreWorkbooksContentEqual(TestHelper.GetExpectedWorkbook(
            nameof(DataSourcePanelDictionaryRenderTest),
